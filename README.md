...
The unit tests establish that the starter repository works. The evaluation measures agent behavior and is expected to have failures at the start.
...
src/state/       workspace state and fixtures
src/tools/       local fake tools; nothing calls external services
src/evals/       visible behavioral cases and runner
